                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-10 p-3">
                            {{ __('The Laravel Pos API is a low-level HTTP-based API for a Laravel admin starter kit that you can use to')}} <code>create/edit/update</code><br> {{ __('Laravel Pos API uses')}}<code>Laravel Passport</code>
